...
class Category_model extends CI_Model
{
     ...
     */
    function get_all_users_category()
    {
        $this->db->order_by('id', 'desc');
    ...
    /**
     * Get limit users-category
     *
     * @param $limit -
     *            limit of query , $start - start of db table index to get query
     *            
     */
    function get_limit_users_category($limit, $start)
    {
        $this->db->order_by('id', 'desc');
        $this->db->limit($limit, $start);
        $this->db->where('users_id', $this->session->userdata('id'));
    ...
    /**
     * Count users-category rows
     */
    function get_count_users_category()
    {
        $this->db->where('users_id', $this->session->userdata('id'));
        $result = $this->db->from("category")->count_all_results();
        $db_error = $this->db->error();

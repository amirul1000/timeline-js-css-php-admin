<a  href="<?php echo site_url('admin/contentmeta/index'); ?>" class="btn btn-info"><i class="arrow_left"></i> List</a>
         ...
         <div class="col-md-8"> 
          ...
          <select name="content_id"  id="content_id"  class="form-control"/> 
            ...
            <?php 
             ...
             {  
            ?> 
            <option value="<?=$dataArr[$i]['id']?>" <?php if($contentmeta['content_id']==$dataArr[$i]['id']){ echo "selected";} ?>><?=$dataArr[$i]['content_title']?></option> 
            <?php 
             } 
            ?> 
          </select> 
...
<div class="form-group"> 
          ...
          <div class="col-md-8"> 
           <input type="text" name="meta_key" value="<?php echo ($this->input->post('meta_key') ? $this->input->post('meta_key') : $contentmeta['meta_key']); ?>" class="form-control" id="meta_key" /> 
          </div> 
           </div>
<div class="form-group"> 
                                        <label for="Meta Value" class="col-md-4 control-label">Meta Value</label> 
          <div class="col-md-8"> 
           <textarea  name="meta_value"  id="meta_value"  class="form-control" rows="4"/><?php echo ($this->input->post('meta_value') ? $this->input->post('meta_value') : $contentmeta['meta_value']); ?></textarea> 
          </div> 
           </div>
